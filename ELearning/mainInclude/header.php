...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      <a href="index.php" class="navbar-brand">Brighter Education Centre</a>
      <span class="navbar-text">Uplifting the Education Standards </span>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          <li class="nav-item custom-nav-item"><a href="courses.php" class="nav-link">Subjects</a></li>
          <li class="nav-item custom-nav-item"><a href="paymentstatus.php" class="nav-link"></a></li>
          <?php 
              session_start();   
          ...
          if (isset($_SESSION['is_admin_login'])) {
            echo '<li class="nav-item custom-nav-item"><a href="admin/adminDashboard.php" class="nav-link"> Teachers Dashboard</a> <a href="logout.php" class="nav-link">Logout</a></li>';
          } else {
            echo '<li class="nav-item custom-nav-item"><a class="nav-link" href="#login" data-toggle="modal" data-target="#adminLoginModalCenter"> Teacher Login</a></li>';
          }
          ?>
